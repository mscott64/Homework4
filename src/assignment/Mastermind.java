 ...
 *
 * I've implemented most of it correctly, but there are a few bugs that still need to be fixed.
 * Write test cases / play the game / force results in the game to find and resolve these bugs.
 */
public class Mastermind {
    ...
    public Mastermind() {
        ...
        fb = new Feedback();
        remaining = new HashSet<Character>();
